"use strict";
angular.module("twentyfourtyeightApp", ["Game", "Grid", "Keyboard", "ngAnimate", "ngCookies"]).config(["GridServiceProvider", function (a) {
    a.setSize(4)
}]).controller("GameController", ["GameManager", "KeyboardService", function (a, b) {
    ...
    var b = function (b, c) {
        this.x = b.x, this.y = b.y, this.value = c || 2, this.id = a.next(), this.merged = null
    };
    return b.prototype.savePosition = function () {
        ...
        a.forEach(function (a) {
            a.merged = !0, a.updatePosition(b.getPosition())
        })
    ...
    this.size = 4, this.startingTileNumber = 2, this.setSize = function (a) {
        this.size = a ? a : 0
    ...
    this.$get = ["TileModel", function (b) {
        ...
        return this.getSize = function () {
            ...
            for (var b = this, c = 0; c < a.size * a.size; c++) this.grid[c] = null;
            ...
            this.forEach(function (a, b, c) {
                c && (c.savePosition(), c.reset())
            })
        }, this.traversalDirections = function (a) {
            for (var b = c[a], d = {
                    x: [],
                    y: []
                }, e = 0; e < this.size; e++) d.x.push(e), d.y.push(e);
            return b.x > 0 && (d.x = d.x.reverse()), b.y > 0 && (d.y = d.y.reverse()), d
        }, this.calculateNextPosition = function (a, b) {
            var d, e = c[b];
            do d = a, a = {
                x: d.x + e.x,
                y: d.y + e.y
            }; while (this.withinGrid(a) && this.cellAvailable(a));
            return {
                newPosition: d,
            ...
            for (var a = 0; a < this.startingTileNumber; a++) this.randomlyInsertNewTile()
            ...
            this.setCellAt(c, null), this.setCellAt(b, a), a.updatePosition(b)
            ...
            a = this._coordinatesToPosition(a), delete this.tiles[a]
    ...
    }, this.grid = c.grid, this.tiles = c.tiles, this.gameSize = c.getSize(), this.winningValue = 2048, this.reinit = function () {
        this.gameOver = !1, this.win = !1, this.currentScore = 0, this.highScore = this.getHighScore()
    }, this.reinit(), this.newGame = function () {
        c.buildEmptyGameBoard(), c.buildStartingPosition(), this.reinit()
        ...
        var d = this,
            e = function () {
                ...
                var a = c.traversalDirections(b),
                    e = !1,
                    f = !1;
                c.prepareTiles(), a.x.forEach(function (g) {
                    a.y.forEach(function (a) {
                        ...
                        if (i) {
                            ...
                            if (k && k.value === i.value && !k.merged) {
                                var l = 2 * i.value,
                                    m = c.newTile(i, l);
                                m.merged = [i, j.next], c.insertTile(m), c.removeTile(i), c.moveTile(m, k), d.updateScore(d.currentScore + j.next.value), m.value >= d.winningValue && (f = !0), e = !0
                            } else c.moveTile(i, j.newPosition);
                            c.samePositions(h, j.newPosition) || (e = !0)
                        }
                    })
                }), f && !d.win && (d.win = !0), e && (c.randomlyInsertNewTile(), (d.win || !d.movesAvailable()) && (d.gameOver = !0))
            };
        return a.when(e())
    }, this.movesAvailable = function () {
        return c.anyCellsAvailable() || c.tileMatchesAvailable()
    }, this.updateScore = function (a) {
        this.currentScore = a, this.currentScore > this.getHighScore() && (this.highScore = a, d.put("highScore", a))
    }
}]);